...
Telegram = 'https://t.me/Unknown_Reason'
...
def print_banners():
    ...
    print(f'{G} â•°âž¤ {Y}Twitter      : {W}{twitter_url}')
    print(f'{G} â•°âž¤ {Y}Discord      : {W}{discord}')
    print(f'{G} â•°âž¤ {Y}Website      : {W}{website}')
    print(f'{G} â•°âž¤ {Y}Blog         : {W}{blog}')
    print(f'{G} â•°âž¤ {Y}Github       : {W}{github}\n')
...
def find_subdomains(domain, filename, timeout=20):
        ...
        try:
            ...
            if response.status_code == 200:
                with subdomains_lock:
                    ...
                    print(f"{Fore.GREEN}Subdomain Found â•°âž¤: {subdomain_url}{Fore.RESET}")
    ...
    print(f"\n{G}â•°âž¤ {C}Total Subdomains Scanned:{W} {len(subdomains)}")
    print(f"{G}â•°âž¤ {C}Total Subdomains Found:{W} {len(subdomains_found)}")
    print(f"{G}â•°âž¤ {C}Time taken:{W} {elapsed_time:.2f} seconds")
